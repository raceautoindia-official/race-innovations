...
export default async function FeaturedReportsPage() {
  const reports = await getFeaturedReports(12);
                ...
                >
                  ...
                  <div className="d-flex flex-column flex-grow-1 p-4">
                    ...
                    <div className="d-flex flex-wrap gap-3 mb-3">
                      <div className="d-flex align-items-center" style={{ color: "#6c7890", fontSize: "0.98rem" }}>
                    ...
                    <div className="d-flex flex-wrap gap-2 mb-4">
                      {(report.tags || []).map((tag, index) => (
                        <span
                          key={index}
                          style={{
                            backgroundColor: tag === "EV" ? "rgba(47, 69, 191, 0.10)" : "#eef2f7",
