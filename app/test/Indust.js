...
function Indust() {
  ...
  return (
    <div
      className={`container-fluid fade-up ${visible.wrapper ? "visible" : ""}`}
      ref={refs.wrapper}
      data-id="wrapper"
    >
      <div className="row align-items-center">
        ...
        <div className="col-12 col-md-6 mt-1 text-center text-md-start">
          ...
          <p
            className={`text-muted px-3 px-md-0 fade-up ${
            ...
            data-id="paragraph"
          >
            RACE has a global presence, spanning Europe, East, West, and North Africa,
            North and Latin America, Korea, China, the UK, as well as other Asian and
            SAARC nations, with its headquarters in India. Our international reach,
            application-focused approach, and deep expertise in the automotive, farm
            equipment and implements, construction, and mining sectors make us the ideal
            local partner for OEMs, vehicle aggregate manufacturers, fleet operators, and
